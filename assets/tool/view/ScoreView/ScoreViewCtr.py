...
# @Last Modified time: 2019-01-23 11:06:47
import os;
import wx;

from _Global import _GG;

from ScoreViewUI import *;
...
class ScoreViewCtr(object):
	"""docstring for ScoreViewCtr"""
	def __init__(self, parent, params = {}):
		super(ScoreViewCtr, self).__init__();
		self.className_ = ScoreViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.UI = ScoreViewUI(parent, curPath = self.curPath, viewCtr = self, params = params);
		self.UI.initView();
